...
DATA_DIR="data/social_iqa_processed_llama_instruct_template"
EXPERIMENT_NAME="Llama3BInstruct-SocialIQa-REINFORCE++-4RTX4090-$(date +%Y%m%d%H%M)"
PROJECT_NAME="DeepEnlighten"
N_GPUS=4
ROLLOUT_TP_SIZE=4
